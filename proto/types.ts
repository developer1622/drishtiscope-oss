// AgentScope WebSocket Protocol — Shared TypeScript Types
// Copy this file into frontend/src/types/protocol.ts
...
export interface WsMessage {
  ...
  ts: string;
  mode: 'ebpf' | 'mock';
  payload: HelloPayload | Snapshot | EventRow | HeartbeatPayload | ErrorPayload | null;
}
